...
export function Settings() {
	...
	const toggleBadgeGroupActive = async (groupId: string) => {
		try {
			...
			toast({
				title: "Success",
				description: `Badge group ${updatedGroup.isActive ? "activated" : "deactivated"
					} successfully`,
			});
		} catch (error: any) {
	...
	return (
		<div>
			<Tabs defaultValue="badges" value={activeTab} onValueChange={setActiveTab}>
				<TabsList className="w-full border-b-0 bg-background mb-6 justify-start">
					<TabsTrigger
						value="badges"
										...
										<div className="p-4 pb-0">
																	...
																	<div className="grid grid-cols-4 gap-4">
																		{[
																			...
																			<button
																				...
																				className={`border rounded-lg p-2 flex flex-col items-center transition-colors ${group.settings.badgeStyle === style.id
																					? "border-primary bg-primary/5"
																					: "border-input hover:border-primary/50"
																					}`}
																			>
																				<div
																					className={`w-10 h-8 rounded flex items-center justify-center ${style.id.includes("card")
																				...
																				>
																					<img
																						...
																						className={`w-full h-full object-contain ${style.id.includes("mono")
																							? "grayscale"
																							: ""
																							}`}
																					/>
											...
											<div className="mt-8 flex items-center justify-between gap-2">
												...
												<Button
													...
													className={`${unsavedGroups[group.id]
